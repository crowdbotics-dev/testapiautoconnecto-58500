...
## Project Structure
    ...
    ├── testapiautoconnecto_58500  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_58500`
...
2. Clone this repo and `cd testapiautoconnecto_58500`
